                                ...
                                <fieldset>
                                    ...
                                    <?php
                                        ...
                                        if($result){
                                            ...
                                            echo "<input type='password' name='boardPass' id='boardPass' placeholder='로그인 비밀번호를 입력해주세요' autocomplate='off' required></div>";
                                        }
                                    ?>
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="boardPass" id="boardPass" placeholder="로그인 비밀번호를 입력해주세요" autocomplate="off" required>
                                    </div> -->
                                </fieldset>
