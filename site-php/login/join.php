                        ...
                        <fieldset>
                            ...
                            <div class="member-box">
                                ...
                                <div>
                                    ...
                                    <input type="pasword" name="youPass" id="youPass" class="input_write" maxlength="20" placeholder="비밀번호를 적어주세요." autocmplete="off" required>
                                </div>
                                <div>
                                    <label for="youPassC">비밀번호 확인</label>
                                    <input type="pasword" name="youPassC" id="youPassC" class="input_write" maxlength="20" placeholder="다시 한번 비밀번호를 적어주세요." autocmplete="off" required>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="youBirth" id="youBirth" class="input_write" maxlength="14" placeholder="YYYY-MM-DD" autocmplete="off" required>
                                </div>
                                <div>
                                    <label for="youPhone">휴대폰 번호</label>
                                    <input type="text" name="youPhone" id="youPhone" class="input_write" maxlength="14" placeholder="000-0000-0000" autocmplete="off" required>
                                </div>
                            </div>
                        </fieldset>
